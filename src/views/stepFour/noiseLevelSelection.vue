<template>
  <div class="noiseLevelSelection">
    ...
    <div class="list_chunk" @click="pushImg(0)">
      <p>强噪声</p>
      <img src="../../assets/image/noiseLeavel1.png" alt />
      <div>
        <p>噪杂混乱的背景噪声中，长期会引起听力下降，影响健康</p>
        <p>工厂/车间/飞机/射击场</p>
        <p>整体背景噪声>90dB</p>
        <p>主要噪声源>3个 或单一噪声源>100dB</p>
      </div>
    </div>
    <div class="list_chunk" @click="pushImg(1)">
      <p>噪杂</p>
      <img src="../../assets/image/noiseLeavel2.png" alt />
      <div>
        <p>噪杂的背景噪声 干扰会话，影响工作休息</p>
        <p>交通噪声/大型工地</p>
        <p>整体背景噪声>70-90dB</p>
        <p>主要噪声源>3个</p>
      </div>
    </div>
    <div class="list_chunk" @click="pushImg(2)">
      <p>轻噪声</p>
      <img src="../../assets/image/noiseLeavel3.png" alt />
      <div>
        <p>少量有限的背景噪声</p>
        <p>小区/超市</p>
        <p>整体背景噪声>45-70dB</p>
    ...
    <div class="list_chunk" @click="pushImg(3)">
      <p>安静</p>
      <img src="../../assets/image/noiseLeavel4.png" alt />
      <div>
        <p>很少有噪声</p>
        <p>居家/办公室</p>
        <p>整体背景噪声>45-70dB</p>
...
export default {
  data() {
    return {
      ...
      imgS: [
        {
          pic: require("../../assets/image/noiseLeavel1.png"),
          name: "强噪声",
          id: 1,
        },
        {
          pic: require("../../assets/image/noiseLeavel2.png"),
          name: "噪杂",
          id: 2,
        },
        {
          pic: require("../../assets/image/noiseLeavel3.png"),
          name: "轻噪声",
          id: 3,
        },
        {
          pic: require("../../assets/image/noiseLeavel4.png"),
          name: "安静",
          id: 4,
        },
      ],
  ...
  methods: {
      ...
      api
        ...
        .then((res) => {
          if (res.data.result == "1") {
            var soundscapeVal = res.data.data.level;
            var soundscapeReconfirmVal = res.data.data.levelReconfirm;
            if (soundscapeVal) {
    ...
    submit() {
      ...
      var row = {
        ...
        sid: localStorage.getItem("sid"),
        level: soundscapeVal,
        levelReconfirm: soundscapeReconfirmVal,
      };
      for (var key in row) {
        if (row[key] == "") {
          delete row[key];
